...
public class GameAuthApplication extends Application<Configuration> {
	...
	public void run(Configuration c, Environment e) throws Exception 
	{
		...
		// SARAHTOMLINSON_Registering GameUserRESTController
		...
		// SARAHTOMLINSON_Created io.dropwizard.client.JerseyClientBuilder instance "client"
		final Client client = new JerseyClientBuilder(e).build("RESTClientReference");
		// SARAHTOMLINSON_Gave client instance to io.dropwizard.setup environment reference
