...
public class SQLiteItemDBHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_1_DESCRIPTION = "description";
    private static final String COLUMN_2_QUANTITY = "quantity";
    ...
    private static final String CREATE_ITEMS_TABLE = "CREATE TABLE IF NOT EXISTS " +
            ...
            COLUMN_1_DESCRIPTION + " VARCHAR, " +
            COLUMN_2_QUANTITY + " VARCHAR" + ");";
    ...
    public void createItem(Item item) {
        ...
        values.put(COLUMN_1_DESCRIPTION, item.getDescription());
        values.put(COLUMN_2_QUANTITY, item.getQuantity());
    ...
    public Item readItem(int id) {
        ...
        Cursor cursor = db.query(ITEM_TABLE_NAME,
                new String[] { COLUMN_0_ID, COLUMN_1_DESCRIPTION, COLUMN_2_QUANTITY }, COLUMN_0_ID + " = ?",
